...
<link rel="stylesheet" href="webshop\style\webaruhaz.css">
...
$sql = "SELECT * FROM termek, kategoria WHERE termek.kategoria_id = kategoria.id AND kategoria.kategoria_neve = 'Laptop'";
