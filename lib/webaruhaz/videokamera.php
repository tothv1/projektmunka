...
<nav class="mb-5 navbar navbar-expand-sm bg-dark navbar-dark">
  <div class="container-fluid">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link active" href="videokamera.php">Videókamera</a>
      </li>
      <li class="nav-item">
...
$sql = "SELECT * FROM termek, kategoria WHERE termek.kategoria_id = kategoria.id AND kategoria.kategoria_neve = 'Videokamera'";
...
if (mysqli_num_rows($result) > 0) {
  ...
  while($row = mysqli_fetch_assoc($result)) {
    ...
    echo 
     ...
     "<td><img src=\"assets/product_images/$row[termek_kepe_kicsi]\" class=\"img-fluid\"></td>";
